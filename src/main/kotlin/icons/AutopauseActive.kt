...
val AutopauseActive: ImageVector
    get() {
        if (_AutopauseActive != null) {
            return _AutopauseActive!!
        }
        _AutopauseActive = ImageVector.Builder(
...
private var _AutopauseActive: ImageVector? = null
